...
<tr>
  ...
  <iframe name="imgpreview" id="imgpreview" src="<?php echo str_replace("/common//common/", "/common/", $preview)?>" style="width: 500px; height: 300px;" scrolling="Auto" marginheight="0" marginwidth="0" frameborder="0"></iframe>
  </td>
</tr>
<tr>
...
<tr>
  ...
  <select name="imglist" id="imglist" size="15" class="input" style="width: 150px;" 
    onchange="if (this.selectedIndex &gt;=0) document.getElementById('imgpreview').src = '<?php echo str_replace("/common//common/", "/common/", $spaw_base_url.$imglib)?>' + this.options[this.selectedIndex].value;" ondblclick="selectClick();"> 
  <?php 
