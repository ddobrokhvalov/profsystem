...
$te_objects=array(
	...
	"TE_OBJECT"=>array(
		...
		"fields"=>array(
			...
			"IN_SEARCH"=>array("title"=>"Индексировать для поиска", "type"=>"checkbox", "no_add"=>1, "show"=>1, "filter"=>1),
			"TAXONOMY_ALLOWED"=>array("title"=>"lang_taxonomy_allowed", "type"=>"checkbox", "no_add"=>1, "no_change"=>1, "show"=>1),
